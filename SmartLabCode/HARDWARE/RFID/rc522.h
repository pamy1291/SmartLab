...
/***********************RC522 函数宏定义**********************/
#define          RC522_CS_Enable()         GPIO_ResetBits ( GPIOA, GPIO_Pin_4 )//sda
#define          RC522_CS_Disable()        GPIO_SetBits ( GPIOA, GPIO_Pin_4 )

#define          RC522_Reset_Enable()      GPIO_ResetBits( GPIOB, GPIO_Pin_0 )//rst
...
u8 card_unlock(void);//卡解锁
u8 card_infor_entry(u8 * oled_use_p);//录入卡
...
size_t my_strlen(const unsigned char* s);//声明自定义的strlen函数
